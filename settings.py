...
CUP2_HEIGHT = 0.12 
CUP2_RADIUS = 0.03
CUP2_START_POS = (0.76, 0.0, 0.0)
CUP2_SCALE = 0.028

CUP3_START_POS = (0.55, 0.0, 0.0)
...
ROD_START_POS = (CUP_START_POS[0] - 0.25, CUP_START_POS[1], CUP_START_POS[2] + (ROD_HEIGHT / 2))
LIFT_HEIGHT = 0.28

CAM_POS = (CUP_START_POS[0], CUP_START_POS[1]-0.5, CUP_START_POS[2])